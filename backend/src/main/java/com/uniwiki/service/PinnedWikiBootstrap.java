...
public class PinnedWikiBootstrap implements ApplicationRunner {
    ...
    private String sourceContent() {
        return """
                ...
                UniWiki의 공식 학교 위키는 아래 세종대학교 공식 사이트의 게시물과 첨부파일을 수집합니다. 신규·변경 자료만 갱신하며 원문 URL과 내용 해시를 함께 보존합니다.
                ...
                게시글 제목과 본문뿐 아니라 PDF, XLS, XLSX, DOCX, TXT, CSV 첨부파일의 텍스트도 추출합니다. 같은 주제의 자료는 하나의 위키로 통합하고 모든 원문 출처를 함께 표시합니다.
    ...
    private String courseGuideContent() {
        return """
                ...
                이 문서는 학기별 수강편람과 강의시간표를 찾기 위한 고정 안내입니다. 수강편람 원문과 첨부 PDF·Excel 파일은 세종대학교 학사공지에서 자동 수집합니다.
